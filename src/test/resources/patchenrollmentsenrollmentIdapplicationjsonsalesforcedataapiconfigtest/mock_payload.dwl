{
  ...
  "items": [
    {
      "exception": {
        "localizedMessage": "Unable to create/update fields: Team_Season__c. Please check the security settings of this field and verify that it is read/write for your profile or permission set. INVALID_FIELD_FOR_INSERT_UPDATE",
        "cause": null,
        "message": "Unable to create/update fields: Team_Season__c. Please check the security settings of this field and verify that it is read/write for your profile or permission set. INVALID_FIELD_FOR_INSERT_UPDATE",
        "stackTrace": [
          {
          ...
          },
          {
            "fileName": null,
            "methodName": "execute",
            "className": "org.mule.extension.salesforce.internal.operation.core.UpdateOperation\$update\$MethodComponentExecutor",
            "nativeMethod": false,
            "lineNumber": -1
          },
          {
